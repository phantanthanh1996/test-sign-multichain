...
var multichain = require('multichain-node')({
    port: 8362,
    host: '35.200.139.31', // using https://github.com/codekitchen/dinghy-http-proxy
    user: 'multichainrpc',
    pass: 'Absb8jcanxEeEGFwE7BR2sbvaEHmYFi4fEfoGAmGdtFw'
});
...
Promise.join(blockchainParamsPromise, assetPromise, function(params, assetName) {
    ...
    console.log('public key: ' + issuer.publicKey.toString('hex'));
    console.log('private key: ' + issuer.privateKey.toString('hex'));
